...
file copy -force ./$proj_name/$proj_name.srcs/sources_1/bd/$bd_name/hw_handoff/$bd_name.hwh ./agc_loopback.hwh
file copy -force ./$proj_name/$proj_name.runs/impl_1/${bd_name}_wrapper.bit ./agc_loopback.bit
